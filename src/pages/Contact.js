...
const Contact = () => {
  return (
    <section
      className="text-body-sm md:text-body-md lg:text-body-lg bg-white relative pt-20"
      data-aos="zoom-out"
      data-aos-delay="300"
    >
      <div className=" max-w-[1440px] mx-auto relative z-10 overflow-hidden py-20 px-6 lg:py-[120px]">
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              <h2 className="h4 md:h3 font-semibold capitalize mb-2">
                GET IN TOUCH WITH US
              </h2>
              <p className="mb-9 text-base leading-relaxed px-1">
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-primary-200 text-base">
                    328 COX RD, SANTA ROSA BEACH, FL 32459
                  </p>
                </div>
              </div>
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-primary-200 text-base">(305) 615 2999</p>
                </div>
              </div>
              <div className="mb-8 flex w-full max-w-[370px]">
                <div className="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
              ...
              <form>
                <div className="mb-6">
                  <input
                    ...
                    className="text-primary-200 focus:border-primary-100 w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                  />
                </div>
                <div className="mb-6">
                  <input
                ...
                <div className="mb-6">
                  <textarea
                    ...
                    className="text-primary-200 focus:border-primary-100 w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                  ></textarea>
                </div>
                <div>
                  <button
                    type="submit"
                    className="bg-primary border-primary w-full rounded border p-3 text-primary-200 transition hover:bg-primary-200 hover:text-white"
                  >
                    Send Message
                  </button>
                </div>
